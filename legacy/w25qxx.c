...
void hal_spi_transmit(uint32_t base, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
  if (pData == NULL)
    return;
...
void hal_spi_receive(uint32_t base, uint8_t *pData, uint16_t Size, uint32_t Timeout)
{
  if (pData == NULL)
    return;
...
bool w25qxx_init(void)
{
  ...
  w25qxx.capacity_in_kilobyte = (w25qxx.sector_count * w25qxx.sector_size) / 1024;
  w25qxx_read_uniq_id();
...
bool w25qxx_is_empty_sector(uint32_t sector_addr, uint32_t offset, uint32_t number)
{
  uint8_t buffer[32];
  uint32_t work_addr;
  uint32_t i;
...
bool w25qxx_is_empty_block(uint32_t block_addr, uint32_t offset, uint32_t number)
{
  uint8_t buffer[32];
  uint32_t work_addr;
  uint32_t i;
...
void w25qxx_write_page(uint8_t *buffer, uint32_t page_addr, uint32_t offset, uint32_t number)
{
  while (w25qxx.lock == 1)
    w25qxx_delay(1);
...
void w25qxx_write_sector(uint8_t *buffer, uint32_t sector_addr, uint32_t offset , uint32_t number)
{
  uint32_t start_page;
...
void w25qxx_write_block   (uint8_t* buffer, uint32_t block_addr, uint32_t offset, uint32_t number)
{
  uint32_t start_page;
  int32_t bytes_to_write;
  uint32_t local_offset;
...
void w25qxx_read_page(uint8_t *buffer, uint32_t page_addr, uint32_t offset, uint32_t number)
{
  while (w25qxx.lock == 1)
    w25qxx_delay(1);
...
void w25qxx_read_sector(uint8_t *buffer, uint32_t sector_addr, uint32_t offset, uint32_t number)
{
  uint32_t start_page;
...
void w25qxx_read_block(uint8_t* buffer, uint32_t block_addr, uint32_t offset, uint32_t number)
{
  uint32_t start_page;
  int32_t bytes_to_read;
  uint32_t local_offset;
